# Project Knowledge — Pro Lash Serum
...
2. **I don't have to choose extensions OR healthy lashes** — bridge: oil-free, extension-safe formulation.
...
## 5. Voice & Language
- **Words to use:** vegan, organic, gentle, oil-free, extension-safe, lash-technician-formulated, tested *(only once testing type is confirmed)*, honest, real.
- **Words to avoid:** miracle, guaranteed overnight results, clinically proven *(unless a citable study exists)*, "as seen on," anything implying prostaglandin-style speed without the accompanying risk disclosure.
- **Sample customer-voice phrases (top 15, verbatim from research — see `avatar-sheet.md` for full 20 + sourcing):**
  ...
  6. "nothing happened"
  7. "eyes became red and swollen"
  8. "truly helps to make lashes stronger, longer, denser"
  9. "made their lashes longer, stronger, and healthier in less than a month"
  10. "the fake lashes now gone thanks to the growth"
  11. "lashes became almost twice as long and thicker"
  12. "very visible results"
  13. "thought they had fake eyelashes"
  14. "completely transformed their lashes"
...
- Bottle size / ml, and applicator type (wand vs. fine-tip)?
- Is a money-back guarantee something the founder wants to offer?
- Payment structure — one-time only, or is a subscription planned?
- Is there a real connection to postpartum/hormonal lash thinning worth researching for the young-mothers segment, or should that segment be positioned purely on general ingredient-consciousness instead?
- No existing sales page, site, or ad creative exists yet to audit — everything from Lesson 2 onward is a from-zero build.
